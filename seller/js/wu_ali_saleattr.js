...
jQuery.multialiSaleProps = function(divselectid, data) {
	...
	var template1 = `<div class="elems">
		<div class="sale_attr_elem" >
			<div class="sale_attr_title">
				<div class="title">
					<span class="saleAttrName"></span><span class="red">*</span>
				</div>
			</div>
		...
		var template2 = `<div class="elems sale_attr_value">
									<div class="title">
										<span class="saleAttrName">Color</span><span class="red">*</span>
									</div>
											...
											<div class="option_val attrgroups">
												<div class="sale_attr_select">
													<div class="attrVal">
														...
														<div class="attrVal_dropList" style="display: none; top: 40px;">
															<ul>
	...
	if (Array.isArray(fields)) {
		fields.forEach((fieldItem) => {
			...
			var uploadImgTml = "";
			var showTpl = "";
			var createTpl = $(template1);
			var createTpl2 = $(template2);
			...
			if(options.length==1 && options[0]['@attributes']['displayName']=="other" && options[0]['@attributes']['value']=="-1"){
				...
				options.forEach((item)=>{
					...
					if(rules.canRemark){
						listTemplate += `<li value="${optionVal}" tabindex="-1" role="menuitem" class="next-menu-item">
						...
						listTemplate += `<li value="${optionVal}" tabindex="-1" role="menuitem" class="next-menu-item sale_attr_select_item">
